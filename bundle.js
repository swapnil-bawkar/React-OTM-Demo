...
/***/ function(module, exports, __webpack_require__) {
	...
	var RouterRouter = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Engine = __webpack_require__(257);

	module.exports = React.createElement(
	    Route,
	    { path: '/', component: Main },
	    React.createElement(IndexRoute, { component: Home }),
	    React.createElement(Route, { path: '/question/:questionNo', component: Engine })
	);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var X2JS = __webpack_require__(252);

	function loadData() {
	    return axios.get('/activities/match_choose_otm/SC3eOTM_00_01_04.xml').then(function (response) {
	        var x2js = new X2JS();
	...
	var API = {
	    loadEngineData: function loadEngineData() {
	        return loadData();
	    }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "html, body {\n  height: 100%;\n  color: rgba(0, 0, 0, 0.87);\n  background: #fff;\n  position: relative; }\n\nbody {\n  -webkit-tap-highlight-color: transparent;\n  -webkit-touch-callout: none;\n  min-height: 100%;\n  -webkit-text-size-adjust: 100%;\n  -ms-text-size-adjust: 100%;\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale;\n  margin: 0;\n  padding: 0;\n  font-family: \"Open Sans\", \"Roboto\", \"Helvetica Neue\", sans-serif;\n  font-size: 16px;\n  line-height: 1.5;\n  color: #444; }\n\n#app {\n  display: flex;\n  flex-direction: column;\n  flex: 1 1 auto;\n  box-sizing: border-box;\n  height: 100%; }\n  #app .main {\n    display: flex;\n    flex-direction: column;\n    flex: 1 1 auto;\n    box-sizing: border-box;\n    height: 100%; }\n    #app .main .home {\n      display: flex;\n      flex-direction: column;\n      flex: 1 1 auto; }\n      #app .main .home .info-text {\n        padding: 8px; }\n      #app .main .home .scoring-area {\n        padding: 8px;\n        background-color: #31b7bf;\n        display: flex;\n        flex-direction: column;\n        flex: 1; }\n      #app .main .home .footer {\n        display: flex;\n        flex-direction: column; }\n        #app .main .home .footer button {\n          height: 46px; }\n", ""]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./score-bar.scss", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./score-bar.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./question.scss", function() {
				var newContent = require("!!./../../../../node_modules/css-loader/index.js!./../../../../node_modules/sass-loader/index.js!./question.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./engine.scss", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js!./../../../node_modules/sass-loader/index.js!./engine.scss");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
